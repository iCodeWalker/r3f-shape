...
const BackSupportModel = ({
  ...
  bedModel.lineTo(4.3, width); // y-coordinate is width of bed, x-coordinate is "How much the bed has wood"
  bedModel.lineTo(4.3, 0);
  bedModel.lineTo(0, 0);
  bedModel.closePath();
...
export default BackSupportModel;
